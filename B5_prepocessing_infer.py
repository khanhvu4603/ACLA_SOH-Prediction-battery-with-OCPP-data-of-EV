...
DC_INPUT_PATHS = [
    r"E:\ACLA + ANODE\data\DC_thang5_2025.csv",
    # có thể thêm nhiều file nữa...
]

OUT_DIR        = r"E:\ACLA + ANODE\output_infer"
OUT_TXN_NOMINAL= os.path.join(OUT_DIR, "transaction_nominal_capacity.csv")
OUT_DATASET    = os.path.join(OUT_DIR, "ocpp_lstm_infer.npz")
OUT_META       = os.path.join(OUT_DIR, "ocpp_lstm_infer_sessions.csv")
OUT_SERIES     = os.path.join(OUT_DIR, "ocpp_lstm_infer_series.csv")
