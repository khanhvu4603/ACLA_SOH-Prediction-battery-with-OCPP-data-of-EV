...
Cách dùng:
  ...
  2) Chạy:  python B5_infer_acla_anode_mc.py
...
META_PATH  = r"E:\ACLA + ANODE\output_infer\transaction_nominal_capacity.csv"   # (tuỳ chọn) csv meta cùng thứ tự hàng để ghép car_model,...
